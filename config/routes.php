...
SilkRoute::register_route("/blog/admin/:action", array('component' => 'app', 'controller' => 'admin'));
SilkRoute::register_route("/blog/admin", array('action' => 'index', 'component' => 'app', 'controller' => 'admin'));
...
SilkRoute::register_route('/blog', array('component' => 'blog', 'action' => 'index', 'id' => '', 'controller' => 'view'));
